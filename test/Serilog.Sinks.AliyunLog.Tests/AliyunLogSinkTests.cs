    ...
    public class AliyunLogSinkTests
    {
        ...
        public void EventsAreWrittenToTheAliyunLog()
        {
            ...
            var log = new LoggerConfiguration()
                .WriteTo.AliyunLog(client, "sink-log-store", logTags: new Dictionary<string, string> {
                    { "Env", "UnitTest" },
            ...
            log.ForContext<AliyunLogSinkTests>().Error(new NotImplementedException(), "this is error message with context {@stats}", stats);
